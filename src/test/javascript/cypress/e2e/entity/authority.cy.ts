...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '4ff6310d-bea1-4115-acc5-1573db2b1ce8' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('0a14c072-0c8c-4e64-85da-2436f69777e8');
      cy.get(`[data-cy="name"]`).should('have.value', '0a14c072-0c8c-4e64-85da-2436f69777e8');
